...
# (str) Package name
package.name = concretestrength

# (str) Package domain (needed for android/ios packaging)
package.domain = com.example.concretestrength
...
requirements = python3,kivy==2.3.1,kivymd==1.2.0,numpy,pandas,scikit-learn
...
# (str) python-for-android URL, for custom toolchain
# p4a.url =
